...
//////////////////////////////////////////////////////////////////////
	...
	gulp.task('copy', ['copy-modernizr', 'copy-jquery', 'copy-fa-font']);
	...
	gulp.task('copy-fa-font', function(){
		return gulp.src('bower_components/font-awesome/fonts/*')	// Gets the font files
            .pipe(gulp.dest('assets/fonts/'))						// Set destination to assets/js
            .pipe(notify('FA Fonts copied'));						// Output to notification
    });
